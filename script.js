...
// ── CATÁLOGO ──
const bicudos = [
  { id: 1,  nome: "Aue",            sexo: "Macho", pai: "Mamute",        mae: "Amorosa de Ouro", foto: "aue.jpg",           genealogia: `<img src="aue.jpg"           alt="Aue"           style="width:100%;border-radius:4px;">` },
  ...
  { id: 4,  nome: "Big New",        sexo: "Macho", pai: "Big Junior CLB",mae: "Espoleta",       foto: "big-new.jpg",       genealogia: `<img src="big-new.jpg"       alt="Big New"       style="width:100%;border-radius:4px;">` },
  { id: 5,  nome: "Big Rio",        sexo: "Macho", pai: "Jujinho CLB",   mae: "Fantinha CLB",   foto: "big-rio.jpg",       genealogia: `<img src="big-rio.jpg"       alt="Big Rio"       style="width:100%;border-radius:4px;">` },
  { id: 6,  nome: "Cara Preta",     sexo: "Macho", pai: "Jeferson",      mae: "Vigogi",         foto: "cara-preta.jpg",    genealogia: `<img src="cara-preta.jpg"    alt="Cara Preta"    style="width:100%;border-radius:4px;">` },
  ...
  { id: 8,  nome: "Cosa Nostra",    sexo: "Macho", pai: "Texas",         mae: "Goialinda",      foto: "cosa-nostra.jpg",   genealogia: `<img src="cosa-nostra.jpg"   alt="Cosa Nostra"   style="width:100%;border-radius:4px;">` },
  ...
  { id: 10, nome: "Lobo Solitário", sexo: "Macho", pai: "Juriti",        mae: "Chica",          foto: "lobo-solitario.jpg",genealogia: `<img src="lobo-solitario.jpg" alt="Lobo Solitário" style="width:100%;border-radius:4px;">` },
  ...
  { id: 13, nome: "Neon",           sexo: "Macho", pai: "Risgoia",       mae: "Cristal",        foto: "neon.jpg",          genealogia: `<img src="neon.jpg"          alt="Neon"          style="width:100%;border-radius:4px;">` },
  { id: 14, nome: "Príncipe Jr",    sexo: "Macho", pai: "Príncipe Negro",mae: "Hanna",          foto: "principe-jr.jpg",   genealogia: `<img src="principe-jr.jpg"   alt="Príncipe Jr"   style="width:100%;border-radius:4px;">` },
  ...
  { id: 16, nome: "Tribalista",     sexo: "Macho", pai: "Juninho",       mae: "Penata",         foto: "tribalista.jpg",    genealogia: `<img src="tribalista.jpg"    alt="Tribalista"    style="width:100%;border-radius:4px;">` }
];
