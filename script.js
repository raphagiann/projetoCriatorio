...
const bicudos = [
  ...
  { id: 12, nome: "Nego Drama",     sexo: "Macho", pai: "Madrid",        mae: "Avani BLC",      foto: "fotosevideos/nego-drama.jpg",    genealogia: `<iframe src="fotosevideos/nego-drama_certificado.pdf" style="width:100%;height:520px;border:none;border-radius:4px;"></iframe><p style="text-align:center;margin-top:8px;"><a href="fotosevideos/nego-drama_certificado.pdf" target="_blank" style="color:#c8a84b;font-size:13px;">&#128196; Abrir certificado em nova aba</a></p>` },
  { id: 15, nome: "Romário",        sexo: "Macho", pai: "Fortuna",       mae: "Penata",         foto: "fotosevideos/romario.jpg",       genealogia: `<img src="fotosevideos/romario.jpg"       alt="Romário"       style="width:100%;border-radius:4px;">` },
